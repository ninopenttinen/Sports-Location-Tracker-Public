  ...
  render() {
    ...
    return (
      <Map
        ...
        center={
          !selectingFromMap && enableMapCentering
      ...
      >
        {
          ...
          view === 'add' ? (
            ...
            <Marker
              position={{
                lat: searchViewLatitude,
                lng: searchViewLongitude,
              }}
              style={{ color: 'red' }}
              onClick={onMarkerClick}
              name={'YOUR LOCATION'}
        ...
        >
          ...
          >
            ...
            {view === 'results' ? (
              <React.Fragment>
                <p style={{ margin: '2%', marginTop: '5%' }}>
                  <b>Type:</b>&nbsp;{this.state.selectedPlace.type}
                </p>
                <p style={{ margin: '2%' }}>
                  <b>Rating:</b>&nbsp;{this.state.selectedPlace.rating}
                </p>
                <p style={{ maxHeight: '5em', margin: '2%' }}>
                  <b>Description:</b>&nbsp;
