...
export class App extends Component {
    ...
    saveResults = (data) => {
        this.setState({ data }, () => { this.handleViewChange('results') });
    };
    ...
    handleDelete = () => {
        ...
        this.setState({ loading: true }, () => {
            axios.post(`http://localhost:9000/api/locations/delete`,
            {
                id: selectedLocation
            })
    ...
    render() {
        ...
        if (view === 'search') menu = <SearchMenu
        ...
        if (view === 'results') menu = <ResultsDisplay
        ...
        return (
            <React.Fragment>
                <header>
                    <button className={(view === 'search') ? 'active-btn':''} 
                            onClick={() => handleViewChange('search')}>Search</button>
                    <button className={(view === 'results') ? 'active-btn':''} 
                            onClick={() => handleViewChange('results')}>Results</button>
                    <button className={(view === 'add') ? 'active-btn':''} 
                            onClick={() => handleViewChange('add')}>Add location</button>
